...
```bash
# 查询当前用户今天的忙闲（默认）
xfchat_cli calendar +freebusy

# 自定义时间范围（仅日期）
xfchat_cli calendar +freebusy --start 2026-03-11 --end 2026-03-12

# 自定义时间范围（完整 ISO 8601）
xfchat_cli calendar +freebusy --start "2026-03-11T08:00:00+08:00" --end "2026-03-11T18:00:00+08:00"

# 查询指定用户的忙闲信息
xfchat_cli calendar +freebusy --start 2026-03-11 --end 2026-03-12 --user-id ou_xxx

# 人类可读格式输出
xfchat_cli calendar +freebusy --format pretty
```
...
```bash
# 查询多个成员，对比找出共同空闲时间
xfchat_cli calendar +freebusy --start 2026-03-12 --user-id ou_member_a
xfchat_cli calendar +freebusy --start 2026-03-12 --user-id ou_member_b
```
