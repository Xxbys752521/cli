...
# 自定义时间范围（ISO 8601）
xfchat_cli calendar +agenda --start "2026-03-10T00:00+08:00" --end "2026-03-17T00:00+08:00"

# 自定义时间范围（仅日期）
xfchat_cli calendar +agenda --start 2026-03-10 --end 2026-03-17

# 人类可读格式输出
xfchat_cli calendar +agenda --format pretty

# 指定日历
xfchat_cli calendar +agenda --calendar-id cal_xxx
```
...
- 查看多个日历：先用 `xfchat_cli calendar calendars list --page-all` 列出日历列表，再逐个查询。
