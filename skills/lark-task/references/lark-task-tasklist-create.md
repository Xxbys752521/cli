...
xfchat_cli task +tasklist-create --name "Q1 Goals"

# Create a tasklist and add members
xfchat_cli task +tasklist-create --name "Project A" --member "ou_xxx,ou_yyy"

# Create a tasklist and batch create tasks within it
xfchat_cli task +tasklist-create --name "Launch Checklist" --data '[{"summary": "Code Review", "assignee": "ou_aaa"}, {"summary": "Deploy", "assignee": "ou_bbb"}]'
```
...
2. Execute the command `xfchat_cli task +tasklist-create ...`.
