...
```bash
# Add a member
xfchat_cli task +tasklist-members --tasklist-id "tl_xxx" --add "ou_aaa"

# Remove a member
xfchat_cli task +tasklist-members --tasklist-id "tl_xxx" --remove "ou_aaa"

# Replace all members exactly
xfchat_cli task +tasklist-members --tasklist-id "tl_xxx" --set "ou_aaa,ou_bbb"
```
